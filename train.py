...
def train_model(model, epochs, opt, loss, batch_size):
    ...
    # create dataset
    PATH_D_TRAIN=os.getcwd() + "/DataTrain/input_tiles/"
    PATH_S_TRAIN=os.getcwd()+"/DataTrain/output_matrix/"
    PATH_D_TEST=os.getcwd()+"/DataTest/input_tiles/"
    PATH_S_TEST=os.getcwd()+"/DataTest/output_matrix/"
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            if epoch%50 == 0:
                PATH_MOD=os.getcwd()+"/Methane_training_data/mod/"
...
PATH_RUNS =os.getcwd()+'/Methane_training_data/runs/'
